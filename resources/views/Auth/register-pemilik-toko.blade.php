...
<head>
  <meta charset="UTF-8">
  <title>Register Pemilik Toko</title>
  <link rel="stylesheet" href="{{ asset('assets/css/bootstrap.min.css') }}">
</head>
<body>
  <div class="container mt-5">
    <h2 class="text-center mb-4">Register Pemilik Toko</h2>
    ...
    <form action="{{ url('/register/pemiliktoko') }}" method="POST" class="p-4 border rounded">
      @csrf
